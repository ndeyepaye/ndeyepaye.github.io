...
print("#Q7")
maison.find({$and:[{listing_id:{$not:/.*rive-sud.*/}} ,{listing_id:{$not:/.*chaudiere-appalaches.*/}},{heating_source:{$nin:["Thermopompe","Bois"]}}]}).count()
...
print("#Q9")
maison.find({$and:[{listing_id:{$not:/.*rive-sud.*/}} ,{listing_id:{$not:/.*chaudiere-appalaches.*/}},{heating_source:{$nin:["Thermopompe","Bois"]}}]})[0].listing_id.split("/")[3]
